...
export const metadata: Metadata = {
  title: "Artisan Table - Fine Dining Restaurant",  description: "Experience culinary excellence at Artisan Table. Award-winning fine dining with innovative seasonal menus and exceptional service.",  keywords: "fine dining, restaurant, gourmet cuisine, reservations, upscale dining",  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    type: "website",    title: "Artisan Table - Fine Dining Restaurant",    description: "Experience culinary excellence at Artisan Table. Award-winning fine dining with innovative seasonal menus.",    siteName: "Artisan Table",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/wicker-gray-table-with-glass-gray-chairs_140725-3025.jpg",        alt: "Artisan Table Fine Dining"},
    ],
  },
  twitter: {
    card: "summary_large_image",    title: "Artisan Table - Fine Dining Restaurant",    description: "Experience culinary excellence. Reserve your table today.",    images: ["http://img.b2bpic.net/free-photo/wicker-gray-table-with-glass-gray-chairs_140725-3025.jpg"],
  },
};
